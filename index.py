    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                print("图像+1,已有" + str(self.__counter) + "张图")
                self.__counter += 1
        return
...
if __name__ == '__main__':
    ...
    for key in label_id_name_dict:
        print(key+':'+label_id_name_dict[key])
    # crawler.start('美女', 10, 2)  # 抓取关键词为 “美女”，总数为 1 页（即总共 1*60=60 张），开始页码为 2
        crawler.start(label_id_name_dict[key], 6, 1)  # 抓取关键词为 “二次元 美女”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
